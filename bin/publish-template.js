...
const TEMPLATE_SRC = path.resolve(__dirname, '../views/page-navigation.pug')
const TEMPLATE_DEST = path.resolve(
    process.cwd(),
    `views/vendor/${pluginName}/page-navigation.pug`
)
...
try {
    ...
    console.log(`✅ Page navigation template copied to: ${TEMPLATE_DEST}`)
} catch (error) {
